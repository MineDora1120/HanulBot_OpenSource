...
module.exports = {
    ...
    {    
        ...
        if(guildQueue.repeat == "off") 
        {
            guildQueue.repeat = "on"
            interaction.editReply("**"+ ":leftwards_arrow_with_hook:" + " __반복을 ``활성화``했어요.__**")
            return;
        }


        guildQueue.repeat = "off"
        interaction.editReply("**" + ":arrow_right:" +"__반복을 ``비활성화``했어요.__ **")
        return;
    }
}